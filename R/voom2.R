...
#' @return see voom from limma package
#' @param counts see voom from limma package
#' @param design see voom from limma package
#' @param lib.size see voom from limma package
#' @param normalize.method see voom from limma package
#' @param block see voom from limma package
#' @param correlation see voom from limma package
#' @param weights see voom from limma package
#' @param span see voom from limma package
#' @param plot see voom from limma package
#' @param save.plot see voom from limma package
#' @param lib.size.all argument used by limma_voom_imputed_data_list and limma_voom_imputed_data_list_parallel functions. See description.
...
#'
voom2 <- function(counts, design=NULL, lib.size=NULL, normalize.method="none", block=NULL, correlation=NULL, weights=NULL, span=0.5, plot=FALSE, save.plot=FALSE, lib.size.all)
